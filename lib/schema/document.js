...
Document.prototype.checkInputType = function (o) {
  // accept { anything } and [ [args...,] {anything} ]
  if (typeof o !== 'object') return false;
  if (!Array.isArray(o)) return true;
  return (typeof _.last(o) === 'object') && (!Array.isArray(_.last(o)));
};
