 ...
 * @typedef nameOpt
 * @type {Object}
 * @property {boolean} first Only return first name
 * @property {boolean} last Only return last name
 * @property {(boolean|string)} middle [description]
 */
/**
 * [name description]
 * @param {nameOpt} opt [description]
 * @type {string} opt.first
 * @property {string} test [description]
