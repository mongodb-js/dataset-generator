...
/**
 * Generate a string, or an array of components, of random address
 * @method
 * @api public
 * @param {...Context.OptionHash}
...
/**
 * Generate a string of random credit card number by default. Can be configured
 * to generate string, or array of components of, other credit card info.
 * @method
 * @api public
 * @param {...Context.OptionHash}
 * @property {boolean} array Format the output as an array?
